...
public class Mvp_HappyPath_NaturalWoodWasteRecyclingInd_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Natural Wood Waste Recycling Individual Facility Permit - Natural Wood Waste Recycling Individual Facility Permit - New")
    public void mvpHappyPathNaturalWoodWasteRecyclingIndNew() throws InterruptedException {
