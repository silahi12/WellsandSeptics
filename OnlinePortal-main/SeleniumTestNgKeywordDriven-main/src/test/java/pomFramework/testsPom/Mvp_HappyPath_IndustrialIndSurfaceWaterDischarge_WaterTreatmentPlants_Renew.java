...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_WaterTreatmentPlants_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Water Treatment Plants - Renew")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeWaterTreatmentPlantsRenew() throws InterruptedException {
