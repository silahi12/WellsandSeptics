...
public class Mvp_HappyPath_RefuseDisposal_ProcessingTransferFacility_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Processing & Transfer Facility";
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Detailed engineering plan";
    private static final String REQUIRED_UPLOAD_FILE3 = "Engineering Specifications";
    private static final String REQUIRED_UPLOAD_FILE4 = "Operating manual for the proposed landfill";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Refuse Disposal Permit - Processing & Transfer Facility - Modification")
    public void mvpHappyPathRefuseDisposalProcessingTransferFacilityModification() throws InterruptedException {
