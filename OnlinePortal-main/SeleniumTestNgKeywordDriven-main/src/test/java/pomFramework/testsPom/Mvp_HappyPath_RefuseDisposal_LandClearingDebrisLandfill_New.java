...
public class Mvp_HappyPath_RefuseDisposal_LandClearingDebrisLandfill_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Land Clearing Debris Landfill - New")
    public void mvpHappyPathRefuseDisposalLandClearingDebrisLandfillNew() throws InterruptedException {
