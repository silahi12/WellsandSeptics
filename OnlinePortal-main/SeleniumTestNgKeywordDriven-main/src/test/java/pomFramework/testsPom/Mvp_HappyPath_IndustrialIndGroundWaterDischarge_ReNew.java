...
public class Mvp_HappyPath_IndustrialIndGroundWaterDischarge_ReNew extends BaseTestPom{
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Worker Compensation Form";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Industrial Individual Ground Water Discharge Permit - Groundwater Discharge Permit Application for Industrial wastewater - Renew ")
    public void mvpHappyPathIndustrialIndGroundWaterDischargeRenew() throws InterruptedException {
