...
public class Mvp_HappyPath_RefuseDisposal_Incinerator_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Incinerator - Renew")
    public void mvpHappyPathRefuseDisposalIncineratorRenew() throws InterruptedException {
