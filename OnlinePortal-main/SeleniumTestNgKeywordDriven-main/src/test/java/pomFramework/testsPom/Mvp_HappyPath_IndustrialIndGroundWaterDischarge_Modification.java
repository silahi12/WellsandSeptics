...
public class Mvp_HappyPath_IndustrialIndGroundWaterDischarge_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Industrial Individual Ground Water Discharge Permit";
    private static final String PERMIT_DETAIL_TYPE = "Groundwater Discharge Permit Application for Industrial wastewater";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Groundwater Discharge Permit Application for Industrial wastewater File",
            "Worker Compensation Form File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Industrial Groundwater Discharge Permit - Wastewater - WSA.pdf",
            "Certification of Worker's Compensation Insurance Coverage - Wastewater - WSA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE1 = "Groundwater Discharge Permit Application for Industrial wastewater";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Industrial Individual Ground Water Discharge Permit - Groundwater Discharge Permit Application for Industrial wastewater - Modification ")
    public void mvpHappyPathIndustrialIndGroundWaterDischargeModification() throws InterruptedException {
