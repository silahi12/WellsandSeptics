...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_NewSourcesDischargeProcessWastewater_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for New Sources that Discharge Process Wastewater - Renew ")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeNewSourcesDischargeProcessWastewaterRenew() throws InterruptedException {
