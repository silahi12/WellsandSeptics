...
public class Mvp_HappyPath_GeneralDischargePermits_SwimmingPoolsSpas_SI_NOI_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permits for Discharges From Swimming Pools & Spas (SI) Notice of Intent (NOI)";
    private static final String PERMIT_DETAIL_TYPE = "General Discharge Permits for Discharges From Swimming Pools & Spas (SI) Notice of Intent (NOI)";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("For Discharges From Swimming Pools & Spas Notice of Intent (NOI) File",
            "17SI Exemption Form File"
            ,"17SI Groundwater Exemption Form File",
            "Transfer Request Form File",
            "Termination Request Form File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Discharges from Swimming Pools and Spas - Wastewater - WSA.pdf",
            "Discharges from Swimming Pools and Spas - 17SI Exemption Form - Wastewater - WSA.pdf",
            "Discharges from Swimming Pools and Spas - 17SI Groundwater Exemption Form - Wastewater - WSA.pdf",
            "General NPDES Permit Transfer Request Form - Wastewater - WSA.pdf",
            "Notice of Termination for Coverage - Surface Water Discharge General Permit - Wastewater - WSA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Permit Application";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying General Discharge Permits for Discharges From Swimming Pools & Spas (SI) Notice of Intent (NOI)- General Discharge Permits for Discharges From Swimming Pools & Spas (SI) Notice of Intent (NOI) - Modification")
    public void mvpHappyPathGeneralDischargePermitsSwimmingPoolsSpasSINOIModification() throws InterruptedException {
