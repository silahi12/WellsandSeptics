...
public class Mvp_HappyPath_RefuseDisposal_RubbleLandfill_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Rubble Landfill";
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Rubble Landfill - Modification")
    public void mvpHappyPathRefuseDisposalRubbleLandfillModification() throws InterruptedException {
