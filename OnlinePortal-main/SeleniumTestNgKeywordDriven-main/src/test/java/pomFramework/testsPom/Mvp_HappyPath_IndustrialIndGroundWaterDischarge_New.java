...
public class Mvp_HappyPath_IndustrialIndGroundWaterDischarge_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Ground Water Discharge Permit - Groundwater Discharge Permit Application for Industrial wastewater - New ")
    public void mvpHappyPathIndustrialIndGroundWaterDischargeNew() throws InterruptedException {
