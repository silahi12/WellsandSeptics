...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_PortableCrushing extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Portable Crushing/Screening Equipment at Temporary Sites";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application for Portable Crushing/Screening Equipment at Temporary Sites File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Crushing Screening at Temporary Site - Form 41 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application for Portable Crushing/Screening Equipment at Temporary Sites";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Portable Crushing/Screening Equipment at Temporary Sites - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructPortableCrushing() throws InterruptedException {
