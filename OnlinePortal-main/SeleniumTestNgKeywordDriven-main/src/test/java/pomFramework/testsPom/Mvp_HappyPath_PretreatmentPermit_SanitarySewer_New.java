...
public class Mvp_HappyPath_PretreatmentPermit_SanitarySewer_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Pretreatment Permits- For Pretreatment to Discharge Wastewater to the Sanitary Sewer - New")
    public void mvpHappyPathGeneralDischargePermitsPretreatmentPermitSanitarySewerNew () throws InterruptedException {
