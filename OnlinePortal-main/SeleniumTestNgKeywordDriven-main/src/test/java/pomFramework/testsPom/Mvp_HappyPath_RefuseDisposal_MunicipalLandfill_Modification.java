...
public class Mvp_HappyPath_RefuseDisposal_MunicipalLandfill_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Municipal Landfill";
    ...
    private static final String REQUIRED_UPLOAD_FILE7 = "One year of ground water data";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Refuse Disposal Permit - Municipal Landfill - Modification")
    public void mvpHappyPathRefuseDisposalMunicipalLandfillModification() throws InterruptedException {
        ...
        //Verify under Upload permit files section REQUIRED_UPLOAD_FILEis displayed
        Assert.assertTrue(mvpUploadPage.isRequiredFileNameDisplayedUnderUploadPermitFilesMvp(REQUIRED_UPLOAD_FILE7), "Required Upload permit file - " + REQUIRED_UPLOAD_FILE7 + " is not displayed");

        // Upload files for REQUIRED_UPLOAD_FILE1
        // Define the name of the file you want to upload from your test_files directory
        String localFileName7 = "jpegTest.jpg"; // This file should be in src/test/resources/resourcesPOM/testFiles/
        // Construct the absolute path to your test file
        String filePath7 = System.getProperty("user.dir") + File.separator +
                "src" + File.separator + "test" + File.separator + "resources" +
                File.separator + "resourcesPOM" +
                File.separator + "testFiles" + File.separator + localFileName7;

        mvpUploadPage.uploadPermitFileMvp(REQUIRED_UPLOAD_FILE7 , filePath7 );
