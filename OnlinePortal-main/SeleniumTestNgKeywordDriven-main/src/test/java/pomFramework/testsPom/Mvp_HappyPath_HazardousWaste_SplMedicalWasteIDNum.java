...
public class Mvp_HappyPath_HazardousWaste_SplMedicalWasteIDNum extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Hazardous Waste - Special Medical Waste ID Number (Generator ID)";
    private static final String PERMIT_DETAIL_TYPE = "Special Medical Waste ID Number (Generator ID)";
    private static final String PERMIT_ACTION_TYPE = "Initial Notification (New)";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("SMW Identification Number File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("SMW ID App Elec_12-27-2024.docx");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "SMW Identification Number";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Hazardous Waste - Special Medical Waste ID Number (Generator ID) - Initial Notification (New)")
    public void mvpHappyPathHazardousWasteSplMedicalWasteIDNum() throws InterruptedException {
