...
public class Mvp_HappyPath_RefuseDisposal_TransferStation_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Transfer Station - Renew")
    public void mvpHappyPathRefuseDisposalTransferStationRenew() throws InterruptedException {
