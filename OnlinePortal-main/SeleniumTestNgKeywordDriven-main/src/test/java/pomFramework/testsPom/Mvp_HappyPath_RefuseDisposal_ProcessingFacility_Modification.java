...
public class Mvp_HappyPath_RefuseDisposal_ProcessingFacility_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Processing Facility";
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Processing Facility - Modification")
    public void mvpHappyPathRefuseDisposalProcessingFacilityModification() throws InterruptedException {
