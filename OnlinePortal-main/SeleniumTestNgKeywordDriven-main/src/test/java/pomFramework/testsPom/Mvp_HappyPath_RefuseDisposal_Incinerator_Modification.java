...
public class Mvp_HappyPath_RefuseDisposal_Incinerator_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Incinerator";
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Incinerator - Modification")
    public void mvpHappyPathRefuseDisposalIncineratorModification() throws InterruptedException {
