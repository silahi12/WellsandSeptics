...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_EmissionControlEquipment extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Emission Control Equipment";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application for Gas Cleaning or Emission Control Equipment File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Emission Control Equipment - Form 6 -ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application for Gas Cleaning or Emission Control Equipment";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Emission Control Equipment - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructEmissionControlEquipment() throws InterruptedException {
