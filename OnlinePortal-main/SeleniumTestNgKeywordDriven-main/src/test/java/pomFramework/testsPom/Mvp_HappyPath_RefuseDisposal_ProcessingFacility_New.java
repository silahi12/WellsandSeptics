...
public class Mvp_HappyPath_RefuseDisposal_ProcessingFacility_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Processing Facility - New")
    public void mvpHappyPathRefuseDisposalProcessingFacilityNew() throws InterruptedException {
