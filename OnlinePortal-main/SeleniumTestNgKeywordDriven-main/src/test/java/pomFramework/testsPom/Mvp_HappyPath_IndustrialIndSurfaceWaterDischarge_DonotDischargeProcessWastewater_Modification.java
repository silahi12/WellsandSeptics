...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_DonotDischargeProcessWastewater_Modification extends BaseTestPom{
    ...
    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Form 1 General Informatiom File",
            "Form 2E File",
    ...
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE1 = "Form 1 General Informatiom";
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for Industrial Sources that Do Not Discharge Process Wastewater - Modification")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeDonotDischargeProcessWastewaterModification() throws InterruptedException {
