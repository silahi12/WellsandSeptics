...
public class Mvp_HappyPath_FederalTitleV_Part70_OperatingPermitApps extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Federal Title V - Part 70 Operating Permit Applications";
    private static final String PERMIT_DETAIL_TYPE = "Part 70 Operating Permit Applications";
    private static final String PERMIT_ACTION_TYPE = "Part 70 Operating Permit Applications";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Part 70 Initial Application Form File",
            "Part 70 Application Form for Renewal File"
            ,"Part 70 Application Form for Minor Modification File",
            "Part 70 Application Form for Significant Modification File",
            "Part 70 Application Form for Administrative Amendment File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Federal Title V - Part 70 Operating Permit - Initial Permit Application-ARA.pdf",
            "Federal Title V - Part 70 Operating Permit - Renewal Permit Application-ARA.pdf",
            "Federal Title V - Part 70 Operating Permit - Minor Modification Permit Application-ARA.pdf",
            "Federal Title V - Part 70 Operating Permit - Significant Modification Permit Application-ARA.pdf",
            "Federal Title V - Part 70 Operating Permit - Administrative Amendment Application - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Part 70 Application Form";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Federal Title V - Part 70 Operating Permit Applications - Part 70 Operating Permit Applications - Part 70 Operating Permit Applications")
    public void mvpHappyPathFederalTitleVPart70OperatingPermitApps() throws InterruptedException {
