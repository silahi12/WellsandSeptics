...
public class Mvp_HappyPath_GeneralDischargePermits_Marinas_MA_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permits for Discharges from Marinas Including Boat Yards and Yacht Basins (MA) Notice of Intent (NOI)";
    private static final String PERMIT_DETAIL_TYPE = "General Discharge Permits for Discharges from Marinas Including Boat Yards and Yacht Basins (MA) Notice of Intent (NOI)";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("For Discharges from Marinas Including Boat Yards and Yacht Basins Notice of Intent (NOI) File",
            "Stormwater Pollution Prevention Plan (SWPPP) File"
            ,"Transfer Request Form File",
            "Termination Request Form File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Discharges from Marinas Including Boat Yards and Yacht Basins - Wastewater - WSA.pdf",
    ...
    @Test(description = "Happy path test for applying General Discharge Permits for Discharges from Marinas Including Boat Yards and Yacht Basins (MA) Notice of Intent (NOI) - General Discharge Permits for Discharges from Marinas Including Boat Yards and Yacht Basins (MA) Notice of Intent (NOI) - Modification")
    public void mvpHappyPathGeneralDischargePermitsMarinasMAModification() throws InterruptedException {
