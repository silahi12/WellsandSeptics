...
public class Mvp_HappyPath_PermitEquivalency_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Permit Equivalency - New")
    public void mvpHappyPathPermitEquivalencyNew() throws InterruptedException {
