...
public class Mvp_HappyPath_PretreatmentPermit_SanitarySewer_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Pretreatment Permits- For Pretreatment to Discharge Wastewater to the Sanitary Sewer - Renew")
    public void mvpHappyPathGeneralDischargePermitsPretreatmentPermitSanitarySewerRenew () throws InterruptedException {
