...
public class Mvp_HappyPath_RefuseDisposal_RubbleLandfill_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Rubble Landfill - New")
    public void mvpHappyPathRefuseDisposalRubbleLandfillNew() throws InterruptedException {
