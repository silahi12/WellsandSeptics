...
public class Mvp_HappyPath_MunicipalIndSurfaceWaterDischarge_WastewaterTreatmentPlantsGreater01MPerDay_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Municipal Individual Surface Water Discharge Permit for Wastewater Treatment Plants with Flows of Greater Than 0.1 Million Gallons Per Day";
    private static final String PERMIT_DETAIL_TYPE = "For Wastewater Treatment Plants with Flows of Greater Than 0.1 Million Gallons Per Day";
    ...
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Individual NPDES Permit - Application Form 1 - General Information - Wastewater - WSA.pdf",
            "NPDES Permit Application Form 2A - New and Existing Publicly Owned Treatment Works - Wastewater - WSA.pdf",
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Form 2A";
    private static final String REQUIRED_UPLOAD_FILE3 = "Worker Compensation Form";
    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Municipal Individual Surface Water Discharge Permit for Wastewater Treatment Plants with Flows of Greater Than 0.1 Million Gallons Per Day - For Wastewater Treatment Plants with Flows of Greater Than 0.1 Million Gallons Per Day - Modification")
    public void mvpHappyPathMunicipalIndSurfaceWaterDischargeWastewaterTreatmentPlantsGreater01MPerDayModification() throws InterruptedException {
