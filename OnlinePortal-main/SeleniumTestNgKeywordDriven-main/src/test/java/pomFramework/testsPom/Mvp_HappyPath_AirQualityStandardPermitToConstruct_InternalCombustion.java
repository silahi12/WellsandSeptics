...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_InternalCombustion extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Internal Combustion Engines";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application for Internal Combustion Engines File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Internal Combustion Engine - Form 44 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application for Internal Combustion Engines";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Internal Combustion Engines - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructInternalCombustion() throws InterruptedException {
