...
public class Mvp_HappyPath_NaturalWoodWasteRecyclingInd_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Natural Wood Waste Recycling Individual Facility Permit - Natural Wood Waste Recycling Individual Facility Permit - Renew")
    public void mvpHappyPathNaturalWoodWasteRecyclingIndRenew() throws InterruptedException {
