...
public class Mvp_HappyPath_NaturalWoodWasteRecyclingFacilityGeneral_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Natural Wood Waste Recycling Facility General Permit";
    private static final String PERMIT_DETAIL_TYPE = "Natural Wood Waste Recycling Facility General Permit";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Natural Wood Waste Recycling Facility General Permit Notice of Intent File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Natural Wood Waste Recycling Facility General Permit Notice of Intent- Permit - LMA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Natural Wood Waste Recycling Facility General Permit Notice of Intent";
    private static final String REQUIRED_UPLOAD_FILE2 = "Emergency Preparedness Manual";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Natural Wood Waste Recycling Facility General Permit - Natural Wood Waste Recycling Facility General Permit - Modification")
    public void mvpHappyPathNaturalWoodWasteRecyclingFacilityGeneralModification() throws InterruptedException {
