...
public class Mvp_HappyPath_RefuseDisposal_ProcessingTransferFacility_New extends BaseTestPom{
    ...
    private static final String REQUIRED_UPLOAD_FILE4 = "Operating manual for the proposed Facility";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Refuse Disposal Permit - Processing & Transfer Facility - New")
    public void mvpHappyPathRefuseDisposalProcessingTransferFacilityNew() throws InterruptedException {
