...
public class Mvp_HappyPath_PermitEquivalency_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Permit Equivalency";
    private static final String PERMIT_DETAIL_TYPE = "For Permit Equivalency";
    ...
    @Test(description = "Happy path test for applying Permit Equivalency - Modification")
    public void mvpHappyPathPermitEquivalencyModification() throws InterruptedException {
