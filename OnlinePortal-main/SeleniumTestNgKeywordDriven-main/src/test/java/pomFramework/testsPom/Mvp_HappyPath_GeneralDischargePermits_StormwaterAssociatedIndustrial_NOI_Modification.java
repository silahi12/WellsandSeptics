...
public class Mvp_HappyPath_GeneralDischargePermits_StormwaterAssociatedIndustrial_NOI_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permits for Discharges of Stormwater Associated with Industrial Activity (SW)";
    private static final String PERMIT_DETAIL_TYPE = "Notice of Intent (NOI)";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("For Discharges of Stormwater Associated with Industrial Activity Notice of Intent (NOI) File",
            "Stormwater Pollution Prevention Plan (SWPPP) File"
            ,"Transfer Request Form File",
            "Termination Request Form File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Discharges from Stormwater Associated with Industrial Activities - Wastewater - WSA.pdf",
    ...
    @Test(description = "Happy path test for applying General Discharge Permits for Discharges of Stormwater Associated with Industrial Activity (SW)- Notice of Intent (NOI) - Modification")
    public void mvpHappyPathGeneralDischargePermitsStormwaterAssociatedIndustrialNOIModification() throws InterruptedException {
