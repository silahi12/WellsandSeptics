...
public class Mvp_HappyPath_AirQualityStatePermitToOperate_Incinerators extends BaseTestPom{
    ...
    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application Form For Incinerators File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Permit to Operate - Incinerators - Form 27 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application Form For Incinerators";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Air Quality State Permit to Operate - Incinerators - State Permit to Operate")
    public void mvpHappyPathAirQualityStatePermitToOperateIncinerators() throws InterruptedException {
