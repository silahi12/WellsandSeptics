...
public class Mvp_HappyPath_AirQualityStatePermitToOperate extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Process Equipments";
    private static final String PERMIT_ACTION_TYPE = "State Permit to Operate";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application Form For Process Equipment File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Permit to Operate - Process Equipment - Form 26 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application Form For Process Equipment";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Air Quality State Permit to Operate - Process Equipments - State Permit to Operate")
    public void mvpHappyPathAirQualityStatePermitToOperate() throws InterruptedException {
