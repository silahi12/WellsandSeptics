...
public class Mvp_HappyPath_PretreatmentPermit_SanitarySewer_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Pretreatment Permits";
    private static final String PERMIT_DETAIL_TYPE = "For Pretreatment to Discharge Wastewater to the Sanitary Sewer";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application for Pretreatment Permit File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Application-Pretreatment Permit Template 2019.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application for Pretreatment Permit";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Pretreatment Permits- For Pretreatment to Discharge Wastewater to the Sanitary Sewer - Modification")
    public void mvpHappyPathGeneralDischargePermitsPretreatmentPermitSanitarySewerModification () throws InterruptedException {
