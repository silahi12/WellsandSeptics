...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_HatcheriesLaboratoriesFish_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For Industrial Surface Water Discharge Permit for Hatcheries and/or Laboratories Raising Fish or Shellfish";
    ...
    private static final List<String> DOWNLOAD_FILES = List.of("Form 1 General Information File",
            "Download the application form Small Aquaculture Facilities File",
    ...
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Individual NPDES Permit - Application Form 1 - General Information - Wastewater - WSA.pdf",
            "Small Aquaculture Facility Discharge Permit Application not requiring NPDES form 2B - Wastewater - WSA.pdf",
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Download the application form Small Aquaculture Facilities";
    private static final String REQUIRED_UPLOAD_FILE3 = "Worker Compensation Form";
    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for Hatcheries and/or Laboratories Raising Fish or Shellfish - Modification")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeHatcheriesLaboratoriesFishModification() throws InterruptedException {
