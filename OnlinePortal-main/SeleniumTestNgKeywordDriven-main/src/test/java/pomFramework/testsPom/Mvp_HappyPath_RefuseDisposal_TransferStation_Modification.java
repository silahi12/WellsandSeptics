...
public class Mvp_HappyPath_RefuseDisposal_TransferStation_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Transfer Station";
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Transfer Station - Modification")
    public void mvpHappyPathRefuseDisposalTransferStationModification() throws InterruptedException {
