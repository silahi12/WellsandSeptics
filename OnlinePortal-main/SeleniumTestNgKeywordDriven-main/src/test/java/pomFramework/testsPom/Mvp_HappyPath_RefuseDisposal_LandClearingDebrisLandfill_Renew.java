...
public class Mvp_HappyPath_RefuseDisposal_LandClearingDebrisLandfill_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Land Clearing Debris Landfill - Renew")
    public void mvpHappyPathRefuseDisposalLandClearingDebrisLandfillRenew() throws InterruptedException {
