...
public class Mvp_HappyPath_RefuseDisposal_MunicipalLandfill_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Municipal Landfill - Renew")
    public void mvpHappyPathRefuseDisposalMunicipalLandfillRenew() throws InterruptedException {
