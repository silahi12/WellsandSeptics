...
public class Mvp_HappyPath_RefuseDisposal_IndustrialLandfill_Modification extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Industrial Landfill - Modification")
    public void mvpHappyPathRefuseDisposalIndustrialLandfillModification() throws InterruptedException {
