...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_NewSourcesDischargeProcessWastewater_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for New Sources that Discharge Process Wastewater - New ")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeNewSourcesDischargeProcessWastewaterNew() throws InterruptedException {
