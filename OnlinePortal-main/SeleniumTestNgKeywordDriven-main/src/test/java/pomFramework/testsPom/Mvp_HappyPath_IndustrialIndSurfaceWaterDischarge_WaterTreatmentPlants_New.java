...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_WaterTreatmentPlants_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Water Treatment Plants - New")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeWaterTreatmentPlantsNew() throws InterruptedException {
