...
public class Mvp_HappyPath_RefuseDisposal_ProcessingTransferFacility_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Processing & Transfer Facility - Renew")
    public void mvpHappyPathRefuseDisposalProcessingTransferFacilityRenew() throws InterruptedException {
