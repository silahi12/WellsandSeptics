...
public class Mvp_HappyPath_NaturalWoodWasteRecyclingInd_Modification extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Natural Wood Waste Recycling Individual Facility Permit";
    private static final String PERMIT_DETAIL_TYPE = "Natural Wood Waste Recycling Individual Facility Permit";
    private static final String PERMIT_ACTION_TYPE = "Modification";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Natural Wood Waste Recycling Facility Individual Permit Application File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Natural Wood Waste Recycling Facility Individual Permit Application - Permit - LMA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Natural Wood Waste Recycling Facility Individual Permit Application";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Natural Wood Waste Recycling Individual Facility Permit - Natural Wood Waste Recycling Individual Facility Permit - Modification")
    public void mvpHappyPathNaturalWoodWasteRecyclingIndModification() throws InterruptedException {
