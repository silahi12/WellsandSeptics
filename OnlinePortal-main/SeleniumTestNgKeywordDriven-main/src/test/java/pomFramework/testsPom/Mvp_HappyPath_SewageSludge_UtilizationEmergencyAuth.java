...
public class Mvp_HappyPath_SewageSludge_UtilizationEmergencyAuth extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Sewage Sludge Utilization Emergency Authorization";
    private static final String PERMIT_ACTION_TYPE = "Transportation Authorization";
    ...
    @Test(description = "Happy path test for applying Sewage Sludge Utilization Permit - Sewage Sludge Utilization Emergency Authorization - Transportation Authorization")
    public void mvpHappyPathSewageSludgeUtilizationEmergencyAuth() throws InterruptedException {
