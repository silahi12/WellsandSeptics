...
public class Mvp_HappyPath_RefuseDisposal_MunicipalLandfill_New extends BaseTestPom{
    ...
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Refuse Disposal Permit Application - LMA";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Refuse Disposal Permit - Municipal Landfill - New")
    public void mvpHappyPathRefuseDisposalMunicipalLandfillNew() throws InterruptedException {
