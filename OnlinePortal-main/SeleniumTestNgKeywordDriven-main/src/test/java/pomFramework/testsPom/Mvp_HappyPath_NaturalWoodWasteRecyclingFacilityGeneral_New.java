...
public class Mvp_HappyPath_NaturalWoodWasteRecyclingFacilityGeneral_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Natural Wood Waste Recycling Facility General Permit - Natural Wood Waste Recycling Facility General Permit - New")
    public void mvpHappyPathNaturalWoodWasteRecyclingFacilityGeneralNew() throws InterruptedException {
