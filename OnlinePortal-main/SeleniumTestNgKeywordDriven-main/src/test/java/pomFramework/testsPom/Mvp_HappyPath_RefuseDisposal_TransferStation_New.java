...
public class Mvp_HappyPath_RefuseDisposal_TransferStation_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Transfer Station - New")
    public void mvpHappyPathRefuseDisposalTransferStationNew() throws InterruptedException {
