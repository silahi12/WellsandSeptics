...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_WaterTreatmentPlants_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For Water Treatment Plants";
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Water Treatment Plants - Modification")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeWaterTreatmentPlantsModification() throws InterruptedException {
