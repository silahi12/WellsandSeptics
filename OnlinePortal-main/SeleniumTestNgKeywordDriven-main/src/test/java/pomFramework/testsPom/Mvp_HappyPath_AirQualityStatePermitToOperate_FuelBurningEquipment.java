...
public class Mvp_HappyPath_AirQualityStatePermitToOperate_FuelBurningEquipment extends BaseTestPom{
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Air Quality State Permit to Operate";
    private static final String PERMIT_DETAIL_TYPE = "Fuel Burning Equipment";
    private static final String PERMIT_ACTION_TYPE = "State Permit to Operate";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application Form For Fuel Burning Equipment File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Permit to Operate - Fuel Burning Equipment - Form 28 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application Form For Fuel Burning Equipment";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying Air Quality State Permit to Operate - Fuel Burning Equipment - State Permit to Operate")
    public void mvpHappyPathAirQualityStatePermitToOperateFuelBurningEquipment() throws InterruptedException {
