...
public class Mvp_HappyPath_PermitEquivalency_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Permit Equivalency - Renew")
    public void mvpHappyPathPermitEquivalencyRenew() throws InterruptedException {
