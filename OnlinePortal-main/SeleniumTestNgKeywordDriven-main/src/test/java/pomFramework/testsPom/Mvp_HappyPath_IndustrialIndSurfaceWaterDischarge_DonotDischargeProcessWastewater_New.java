...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_DonotDischargeProcessWastewater_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for Industrial Sources that Do Not Discharge Process Wastewater - New")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeDonotDischargeProcessWastewaterNew() throws InterruptedException {
