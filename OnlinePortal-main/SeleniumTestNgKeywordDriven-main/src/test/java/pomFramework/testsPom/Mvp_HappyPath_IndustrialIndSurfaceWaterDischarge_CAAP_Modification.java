...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_CAAP_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For Industrial Surface Water Discharge Permit for Concentrated Aquatic Animal Production Facility (CAAP)";
    ...
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Individual NPDES Permit - Application Form 1 - General Information - Wastewater - WSA.pdf",
            "Individual NPDES Permit - Application Form 2B - CAFO and Concentrated Aquatic Animal Production Facilities - Wastewater - WSA.pdf",
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Form 2B";
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for Concentrated Aquatic Animal Production Facility (CAAP) - Modification")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeCAAPModification() throws InterruptedException {
