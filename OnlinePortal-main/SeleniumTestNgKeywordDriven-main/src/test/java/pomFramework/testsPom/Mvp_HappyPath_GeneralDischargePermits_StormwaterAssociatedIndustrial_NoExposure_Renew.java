...
public class Mvp_HappyPath_GeneralDischargePermits_StormwaterAssociatedIndustrial_NoExposure_Renew extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For No Exposure Certification for Exclusion from NPDES Stormwater Permitting";
    private static final String PERMIT_ACTION_TYPE = "Renew";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("For No Exposure Certification for Exclusion from NPDES Stormwater Permitting File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("No Exposure Certification for Exclusion from NPDES Stormwater Permitting - Wastewater - WSA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "For No Exposure Certification for Exclusion from NPDES Stormwater Permitting";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying General Discharge Permits for Discharges of Stormwater Associated with Industrial Activity (SW)- For No Exposure Certification for Exclusion from NPDES Stormwater Permitting - Renew")
    public void mvpHappyPathGeneralDischargePermitsStormwaterAssociatedIndustrialNoExposureRenew() throws InterruptedException {
