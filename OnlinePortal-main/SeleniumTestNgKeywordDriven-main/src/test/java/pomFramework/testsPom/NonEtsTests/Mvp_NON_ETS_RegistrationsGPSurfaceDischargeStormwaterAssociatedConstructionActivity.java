...
public class Mvp_NON_ETS_RegistrationsGPSurfaceDischargeStormwaterAssociatedConstructionActivity extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Registrations under the General Permit (GP) for Surface Discharge of Stormwater Associated with Construction Activity";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/Water/wwp/Pages/gp_construction.aspx";

    @Test(description = "Non ETS redirect url test for applying Registrations under the General Permit (GP) for Surface Discharge of Stormwater Associated with Construction Activity")
    public void mvpNonETSRegistrationsGPSurfaceDischargeStormwaterAssociatedConstructionActivity() {
