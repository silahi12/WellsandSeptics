...
public class Mvp_NON_ETS_OnSiteWastewaterPropertyTransferInspectionLicense extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "On-Site Wastewater Property Transfer Inspection License";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/wwp/Pages/State-Board-of-On-Site-Wastewater-Professionals.aspx";

    @Test(description = "Non ETS redirect url test for applying On-Site Wastewater Property Transfer Inspection License")
    public void mvpNonETSOnSiteWastewaterPropertyTransferInspectionLicense() {
