...
public class Mvp_NON_ETS_IncineratorOperatorCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Incinerator Operator Certification";

    //URL
    private static final String REDIRECT_URL = "regs.maryland.gov/us/md/exec/comar/26.11.08.08-2#H(4)";

    @Test(description = "Non ETS redirect url test for applying Incinerator Operator Certification")
    public void mvpNonETSIncineratorOperatorCertification() {
