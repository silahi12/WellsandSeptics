...
public class Mvp_NON_ETS_PhaseIMunicipalSeparateStormSewer_MS4_IndividualLargeMedium extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Phase I Municipal Separate Storm Sewer (MS4) Permit (Individual, Large and Medium)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/StormwaterManagementProgram/Pages/MS4-Landing.aspx";

    @Test(description = "Non ETS redirect url test for applying Phase I Municipal Separate Storm Sewer (MS4) Permit (Individual, Large and Medium)")
    public void mvpNonETSPhaseIMunicipalSeparateStormSewer_MS4_IndividualLargeMedium() {
