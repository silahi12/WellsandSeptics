...
public class Mvp_NON_ETS_CertifiedEmissionsRepairFacilityCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Certified Emissions Repair Facility Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/MobileSources/Pages/cerf.aspx";

    @Test(description = "Non ETS redirect url test for applying Certified Emissions Repair Facility Certification")
    public void mvpNonETSCertifiedEmissionsRepairFacilityCertification() {
