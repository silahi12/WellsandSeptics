...
public class Mvp_NON_ETS_MarineContractorsLicense_Renew extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Marine Contractors License (Renewal)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/WetlandsandWaterways/Pages/License-Application-Instructions.aspx";

    @Test(description = "Non ETS redirect url test for applying Marine Contractors License (Renewal)")
    public void mvpNonETSMarineContractorsLicense_Renew() {
