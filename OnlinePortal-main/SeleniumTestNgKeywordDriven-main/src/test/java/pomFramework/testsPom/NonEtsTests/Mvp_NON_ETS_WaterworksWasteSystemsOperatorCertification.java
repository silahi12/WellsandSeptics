...
public class Mvp_NON_ETS_WaterworksWasteSystemsOperatorCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Waterworks and Waste Systems Operator Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/permits/environmentalboards/pages/bww.aspx";

    @Test(description = "Non ETS redirect url test for applying Waterworks and Waste Systems Operator Certification")
    public void mvpNonETSWaterworksWasteSystemsOperatorCertification() {
