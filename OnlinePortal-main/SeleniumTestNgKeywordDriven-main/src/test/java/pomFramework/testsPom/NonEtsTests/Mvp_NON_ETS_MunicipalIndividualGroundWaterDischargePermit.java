...
public class Mvp_NON_ETS_MunicipalIndividualGroundWaterDischargePermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Municipal Individual Ground Water Discharge Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/wwp/Pages/GWDP.aspx";

    @Test(description = "Non ETS redirect url test for applying Municipal Individual Ground Water Discharge Permit")
    public void mvpNonETSMunicipalIndividualGroundWaterDischargePermit() {
