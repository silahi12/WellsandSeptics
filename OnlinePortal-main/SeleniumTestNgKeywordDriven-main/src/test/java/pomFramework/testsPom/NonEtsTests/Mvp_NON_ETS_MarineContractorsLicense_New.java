...
public class Mvp_NON_ETS_MarineContractorsLicense_New extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Marine Contractors License (New)";
    ...
    @Test(description = "Non ETS redirect url test for applying Marine Contractors License (New)")
    public void mvpNonETSMarineContractorsLicense_New() {
