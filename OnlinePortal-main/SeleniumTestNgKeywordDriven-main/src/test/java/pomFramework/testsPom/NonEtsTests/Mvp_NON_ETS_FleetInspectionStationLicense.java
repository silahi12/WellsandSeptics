...
public class Mvp_NON_ETS_FleetInspectionStationLicense extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Fleet Inspection Station License";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/MobileSources/Pages/cerf.aspx";

    @Test(description = "Non ETS redirect url test for applying Fleet Inspection Station License")
    public void mvpNonETSFleetInspectionStationLicense() {
