...
public class Mvp_NON_ETS_RadioactiveMaterialsLicense_NewRenewals extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Radioactive Materials License (New and renewals)";
    ...
    @Test(description = "Non ETS redirect url test for applying Radioactive Materials License (New and renewals)")
    public void mvpNonETSRadioactiveMaterialsLicense_NewRenewals() {
