...
public class Mvp_NON_ETS_CoalMiningPermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Coal Mining Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/mining/Pages/permitapplications.aspx";

    @Test(description = "Non ETS redirect url test for applying Coal Mining Permit")
    public void mvpNonETSCoalMiningPermit() {
