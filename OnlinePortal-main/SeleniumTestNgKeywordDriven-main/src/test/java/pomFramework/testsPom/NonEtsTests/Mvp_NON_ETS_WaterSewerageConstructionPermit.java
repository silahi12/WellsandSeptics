...
public class Mvp_NON_ETS_WaterSewerageConstructionPermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Water and/or Sewerage Construction Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/permits/WaterManagementPermits/Pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Water and/or Sewerage Construction Permit")
    public void mvpNonETSWaterSewerageConstructionPermit() {
