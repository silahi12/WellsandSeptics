...
public class Mvp_NON_ETS_RadiationMachineFacilityRegistration_dentalVet extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Radiation Machine Facility Registration (dental and vet)";
    ...
    @Test(description = "Non ETS redirect url test for applying Radiation Machine Facility Registration (dental and vet)")
    public void mvpNonETSRadiationMachineFacilityRegistration_dentalVet() {
