...
public class Mvp_NON_ETS_SmallPondApprovalStateFederalApplicants extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Small Pond Approval for State and Federal Applicants";
    ...
    @Test(description = "Non ETS redirect url test for applying Small Pond Approval for State and Federal Applicants")
    public void mvpNonETSSmallPondApprovalStateFederalApplicants() {
