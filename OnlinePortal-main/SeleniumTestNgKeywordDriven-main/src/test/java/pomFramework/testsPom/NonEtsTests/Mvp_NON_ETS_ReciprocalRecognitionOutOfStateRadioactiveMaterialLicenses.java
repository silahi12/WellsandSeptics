...
public class Mvp_NON_ETS_ReciprocalRecognitionOutOfStateRadioactiveMaterialLicenses extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Reciprocal Recognition of Out-of-State Radioactive Material Licenses";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/RadiologicalHealth/Pages/RadioactiveMaterialsLicensingForms.aspx";

    @Test(description = "Non ETS redirect url test for applying Reciprocal Recognition of Out-of-State Radioactive Material Licenses")
    public void mvpNonETSReciprocalRecognitionOutOfStateRadioactiveMaterialLicenses() {
