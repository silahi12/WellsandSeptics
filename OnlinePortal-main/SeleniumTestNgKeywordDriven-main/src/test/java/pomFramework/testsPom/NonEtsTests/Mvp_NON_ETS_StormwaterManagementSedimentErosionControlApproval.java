...
public class Mvp_NON_ETS_StormwaterManagementSedimentErosionControlApproval extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Stormwater Management and Sediment & Erosion Control Approval";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/StormwaterManagementProgram/Pages/PlanReviewforStateandFederalProjects.aspx";

    @Test(description = "Non ETS redirect url test for applying Stormwater Management and Sediment & Erosion Control Approval")
    public void mvpNonETSStormwaterManagementSedimentErosionControlApproval() {
