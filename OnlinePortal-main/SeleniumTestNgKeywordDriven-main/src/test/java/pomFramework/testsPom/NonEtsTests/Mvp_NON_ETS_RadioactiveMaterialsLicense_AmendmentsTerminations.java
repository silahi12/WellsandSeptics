...
public class Mvp_NON_ETS_RadioactiveMaterialsLicense_AmendmentsTerminations extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Radioactive Materials License (Amendments and terminations)";
    ...
    @Test(description = "Non ETS redirect url test for applying Radioactive Materials License (Amendments and terminations)")
    public void mvpNonETSRadioactiveMaterialsLicense_AmendmentsTerminations() {
