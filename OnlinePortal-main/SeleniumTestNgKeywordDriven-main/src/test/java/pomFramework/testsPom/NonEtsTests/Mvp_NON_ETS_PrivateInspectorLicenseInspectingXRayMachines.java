...
public class Mvp_NON_ETS_PrivateInspectorLicenseInspectingXRayMachines extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Private Inspector License For Inspecting X-Ray Machines";
    ...
    @Test(description = "Non ETS redirect url test for applying Private Inspector License For Inspecting X-Ray Machines")
    public void mvpNonETSPrivateInspectorLicenseInspectingXRayMachines() {
