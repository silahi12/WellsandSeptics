...
public class Mvp_NON_ETS_DrinkingWaterSamplerCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Drinking Water Sampler Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/water_supply/Pages/Drinking_Water_Samples.aspx";

    @Test(description = "Non ETS redirect url test for applying Drinking Water Sampler Certification")
    public void mvpNonETSDrinkingWaterSamplerCertification() {
