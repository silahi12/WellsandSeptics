...
public class Mvp_NON_ETS_AsbestosTrainingProviderApproval extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Asbestos Training Provider Approval";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/asbestos/pages/contractor.aspx";

    @Test(description = "Non ETS redirect url test for applying Asbestos Training Provider Approval")
    public void mvpNonETSAsbestosTrainingProviderApproval() {
