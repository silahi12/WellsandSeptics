...
public class Mvp_NON_ETS_IndividualOilOperationsPermit_OPS extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Individual Oil Operations Permit: Oil Contaminated Soil Storage and Treatment - OPS";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/oilcontrol/pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Individual Oil Operations Permit: Oil Contaminated Soil Storage and Treatment - OPS")
    public void mvpNonETSIndividualOilOperationsPermitOPS() {
