...
public class Mvp_NON_ETS_ScrapTireHauler extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Scrap Tire Hauler";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/ScrapTires.aspx";

    @Test(description = "Non ETS redirect url test for applying Scrap Tire Hauler")
    public void mvpNonETSScrapTireHauler() {
