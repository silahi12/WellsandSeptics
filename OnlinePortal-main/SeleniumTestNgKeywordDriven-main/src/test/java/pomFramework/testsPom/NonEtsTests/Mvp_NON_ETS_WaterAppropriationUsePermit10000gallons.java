...
public class Mvp_NON_ETS_WaterAppropriationUsePermit10000gallons extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Water Appropriation and Use Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/water_supply/Pages/WaterAppropriationsOrUsePermits.aspx";

    @Test(description = "Non ETS redirect url test for applying Water Appropriation and Use Permit (<10,000 gallons)")
    public void mvpNonETSWaterAppropriationUsePermit10000gallons() {
