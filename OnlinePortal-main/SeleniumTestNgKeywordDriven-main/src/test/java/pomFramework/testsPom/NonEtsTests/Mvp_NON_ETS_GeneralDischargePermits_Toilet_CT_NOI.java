...
public class Mvp_NON_ETS_GeneralDischargePermits_Toilet_CT_NOI extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permits for the Discharge of Composting Toilet Wastewater to Groundwater by Land Application (CT) Notice of Intent (NOI)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/Water/wwp/Pages/18_CT.aspx";

    @Test(description = "Non ETS redirect url test for applying General Discharge Permits for the Discharge of Composting Toilet Wastewater to Groundwater by Land Application (CT) Notice of Intent (NOI)")
    public void mvpNonETSGeneralDischargePermits_Toilet_CT_NOI() {
