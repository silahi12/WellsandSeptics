...
public class Mvp_NON_ETS_NonCoalSurfaceMineLicense extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Non-Coal Surface Mine License";

    //URL
    private static final String DOWNLOAD_FILENAME = "Application for License to Surface Mine LJC2021 (2025).pdf";

    @Test(description = "Non ETS redirect url test for applying Non-Coal Surface Mine License")
    public void mvpNonETSNonCoalSurfaceMineLicense() {
