...
public class Mvp_NON_ETS_RadiationMachineFacilityRegistration_allOtherMachines extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Radiation Machine Facility Registration (all other machines)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/RadiologicalHealth/Pages/XRayApplicationFormsandGuidance.aspx";

    @Test(description = "Non ETS redirect url test for applying Radiation Machine Facility Registration (all other machines)")
    public void mvpNonETSRadiationMachineFacilityRegistration_allOtherMachines() {
