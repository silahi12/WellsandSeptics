...
public class Mvp_NON_ETS_RelayingOystersCommercialHarvest extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Relaying Oysters for Commercial Harvest";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/marylander/fishandshellfish/pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Relaying Oysters for Commercial Harvest")
    public void mvpNonETSRelayingOystersCommercialHarvest() {
