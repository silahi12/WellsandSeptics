...
public class Mvp_NON_ETS_GeneralDischargePermits_Pesticides_PE_NOI extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permits for Discharges from the Application of Pesticides (PE) Notice of Intent (NOI)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/permits/watermanagementpermits/pages/gppesticides.aspx";

    @Test(description = "Non ETS redirect url test for applying General Discharge Permits for Discharges from the Application of Pesticides (PE) Notice of Intent (NOI)")
    public void mvpNonETSGeneralDischargePermits_Pesticides_PE_NOI() {
