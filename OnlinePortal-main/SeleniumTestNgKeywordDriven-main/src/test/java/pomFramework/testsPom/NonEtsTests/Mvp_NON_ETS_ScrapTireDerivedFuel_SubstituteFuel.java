...
public class Mvp_NON_ETS_ScrapTireDerivedFuel_SubstituteFuel extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Scrap Tire Derived Fuel/Substitute Fuel";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/ScrapTires.aspx";

    @Test(description = "Non ETS redirect url test for applying Scrap Tire Derived Fuel/Substitute Fuel")
    public void mvpNonETSScrapTireDerivedFuelSubstituteFuel() {
