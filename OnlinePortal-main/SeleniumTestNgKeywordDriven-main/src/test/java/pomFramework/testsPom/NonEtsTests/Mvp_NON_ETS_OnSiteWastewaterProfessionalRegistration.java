...
public class Mvp_NON_ETS_OnSiteWastewaterProfessionalRegistration extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "On-Site Wastewater Professional Registration";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/BayRestorationFund/OnsiteDisposalSystems/Pages/On-Site-PTIs.aspx";

    @Test(description = "Non ETS redirect url test for applying On-Site Wastewater Professional Registration")
    public void mvpNonETSOnSiteWastewaterProfessionalRegistration() {
