...
public class Mvp_NON_ETS_IndividualPermitIndustrialConstructionStormwater extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Individual Permit for Industrial or Construction Stormwater";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/Permits/WaterManagementPermits/Pages/waterpermits.aspx";

    @Test(description = "Non ETS redirect url test for applying Individual Permit for Industrial or Construction Stormwater")
    public void mvpNonETSIndividualPermitIndustrialConstructionStormwater() {
