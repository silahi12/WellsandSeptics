...
public class Mvp_NON_ETS_IndividualOilOperationsPermit_OPX extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Individual Oil Operations Permit: Solidification of Oil Sludge, Refuse, and/or Oil Mixed with other Waste - OPX";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/oilcontrol/pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Individual Oil Operations Permit: Solidification of Oil Sludge, Refuse, and/or Oil Mixed with other Waste - OPX")
    public void mvpNonETSIndividualOilOperationsPermitOPX() {
