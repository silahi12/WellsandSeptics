...
public class Mvp_NON_ETS_ScrapTireSolidWasteAcceptanceFacility extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Scrap Tire Solid Waste Acceptance Facility";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/ScrapTires.aspx";

    @Test(description = "Non ETS redirect url test for applying Scrap Tire Solid Waste Acceptance Facility")
    public void mvpNonETSScrapTireSolidWasteAcceptanceFacility() {
