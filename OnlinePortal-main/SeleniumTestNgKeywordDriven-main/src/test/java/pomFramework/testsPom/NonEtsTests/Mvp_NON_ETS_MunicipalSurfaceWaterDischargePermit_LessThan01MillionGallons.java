...
public class Mvp_NON_ETS_MunicipalSurfaceWaterDischargePermit_LessThan01MillionGallons extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Municipal Surface Water Discharge Permit for Wastewater Treatment Plants with Flows Less Than 0.1 Million Gallons Per Day";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/Water/wwp/Pages/MunicipalSurfaceWater.aspx";

    @Test(description = "Non ETS redirect url test for applying Municipal Surface Water Discharge Permit for Wastewater Treatment Plants with Flows Less Than 0.1 Million Gallons Per Day")
    public void mvpNonETSMunicipalSurfaceWaterDischargePermit_LessThan01MillionGallons() {
