...
public class Mvp_NON_ETS_PhaseIIMunicipalSeparateStormSewerMS4_GeneralMunicipalities extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Phase II Municipal Separate Storm Sewer (MS4) Permit (General, Municipalities)";
    ...
    @Test(description = "Non ETS redirect url test for applying Phase II Municipal Separate Storm Sewer (MS4) Permit (General, Municipalities)")
    public void mvpNonETSPhaseIIMunicipalSeparateStormSewerMS4_GeneralMunicipalities() {
