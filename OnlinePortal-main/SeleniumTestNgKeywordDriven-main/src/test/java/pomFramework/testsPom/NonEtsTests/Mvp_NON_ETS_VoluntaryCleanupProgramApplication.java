...
public class Mvp_NON_ETS_VoluntaryCleanupProgramApplication extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Voluntary Cleanup Program Application";

    //URL
    private static final String DOWNLOAD_FILENAME = "VCP Application Fnl Update May 2025.pdf";

    @Test(description = "Non ETS redirect url test for applying Voluntary Cleanup Program Application")
    public void mvpNonETSVoluntaryCleanupProgramApplication() {
