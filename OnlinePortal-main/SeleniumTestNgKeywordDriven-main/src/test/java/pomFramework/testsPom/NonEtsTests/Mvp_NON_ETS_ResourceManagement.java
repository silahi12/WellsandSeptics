...
public class Mvp_NON_ETS_ResourceManagement extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Resource Management";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/Composting.aspx";

    @Test(description = "Non ETS redirect url test for applying Resource Management")
    public void mvpNonETSResourceManagement() {
