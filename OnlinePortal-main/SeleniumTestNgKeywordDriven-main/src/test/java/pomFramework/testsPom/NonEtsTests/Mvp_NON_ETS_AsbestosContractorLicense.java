...
public class Mvp_NON_ETS_AsbestosContractorLicense extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Asbestos Contractor License";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/asbestos/pages/contractor.aspx";

    @Test(description = "Non ETS redirect url test for applying Asbestos Contractor License")
    public void mvpNonETSAsbestosContractorLicense() {
