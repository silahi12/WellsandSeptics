...
public class Mvp_NON_ETS_DamSafetyPermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Dam Safety Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/DamSafety/Pages/dampermit.aspx";

    @Test(description = "Non ETS redirect url test for applying Dam Safety Permit")
    public void mvpNonETSDamSafetyPermit() {
