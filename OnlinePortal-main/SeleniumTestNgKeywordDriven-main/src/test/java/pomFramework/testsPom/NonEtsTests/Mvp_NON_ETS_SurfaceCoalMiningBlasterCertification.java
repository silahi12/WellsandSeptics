...
public class Mvp_NON_ETS_SurfaceCoalMiningBlasterCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Surface Coal Mining Blaster Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/mining/Pages/permitapplications.aspx";

    @Test(description = "Non ETS redirect url test for applying Surface Coal Mining Blaster Certification")
    public void mvpNonETSSurfaceCoalMiningBlasterCertification() {
