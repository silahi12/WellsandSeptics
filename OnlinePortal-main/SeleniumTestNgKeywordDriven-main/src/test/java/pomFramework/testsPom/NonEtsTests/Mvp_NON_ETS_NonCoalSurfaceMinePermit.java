...
public class Mvp_NON_ETS_NonCoalSurfaceMinePermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Non-Coal Surface Mining Permit";

    //URL
    private static final String DOWNLOAD_FILENAME = "Application For Permit to Surface Mine - MDE-LMA-PER037 (2025).pdf";

    @Test(description = "Non ETS redirect url test for applying Non-Coal Surface Mining Permit")
    public void mvpNonETSNonCoalSurfaceMinePermit() {
