...
public class Mvp_NON_ETS_GeneralDischargePermitAnimalFeedingOperations extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permit for Animal Feeding Operations";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/recyclingandoperationsprogram/pages/afoinfo.aspx";

    @Test(description = "Non ETS redirect url test for applying General Discharge Permit for Animal Feeding Operations")
    public void mvpNonETSGeneralDischargePermitAnimalFeedingOperations() {
