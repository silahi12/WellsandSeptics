...
public class Mvp_NON_ETS_ControlledHazardousSubstancesHaulerVehicleCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Controlled Hazardous Substances Hauler & Vehicle Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/Pages/landpermits.aspx#SWP";

    @Test(description = "Non ETS redirect url test for applying Controlled Hazardous Substances Hauler & Vehicle Certification")
    public void mvpNonETSControlledHazardousSubstancesHaulerVehicleCertification() {
