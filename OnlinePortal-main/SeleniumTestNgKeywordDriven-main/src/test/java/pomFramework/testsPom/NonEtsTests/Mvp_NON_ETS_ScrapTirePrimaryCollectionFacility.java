...
public class Mvp_NON_ETS_ScrapTirePrimaryCollectionFacility extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Scrap Tire Primary Collection Facility";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/ScrapTires.aspx";

    @Test(description = "Non ETS redirect url test for applying Scrap Tire Primary Collection Facility")
    public void mvpNonETSScrapTirePrimaryCollectionFacility() {
