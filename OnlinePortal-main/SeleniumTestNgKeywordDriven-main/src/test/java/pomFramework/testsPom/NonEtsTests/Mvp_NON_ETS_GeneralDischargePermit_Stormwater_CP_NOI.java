...
public class Mvp_NON_ETS_GeneralDischargePermit_Stormwater_CP_NOI extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "General Discharge Permit for Discharges of Stormwater Associated with Construction Activity (CP) Notice of Intent (NOI)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/Water/wwp/Pages/gp_construction.aspx";

    @Test(description = "Non ETS redirect url test for applying General Discharge Permit for Discharges of Stormwater Associated with Construction Activity (CP) Notice of Intent (NOI)")
    public void mvpNonETSGeneralDischargePermit_Stormwater_CP_NOI() {
