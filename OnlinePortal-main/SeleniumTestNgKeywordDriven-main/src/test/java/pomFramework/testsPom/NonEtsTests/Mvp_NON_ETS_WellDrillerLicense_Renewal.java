...
public class Mvp_NON_ETS_WellDrillerLicense_Renewal extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Well Driller License (Renewal)";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/permits/environmentalboards/pages/boardofwelldrillers.aspx";

    @Test(description = "Non ETS redirect url test for applying Well Driller License (Renewal)")
    public void mvpNonETSWellDrillerLicense_Renewal() {
