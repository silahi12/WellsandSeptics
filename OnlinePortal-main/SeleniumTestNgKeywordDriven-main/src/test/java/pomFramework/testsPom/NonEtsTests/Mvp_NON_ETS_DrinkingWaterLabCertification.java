...
public class Mvp_NON_ETS_DrinkingWaterLabCertification extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Drinking Water Lab Certification";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/water_supply/pages/wsp-labcert.aspx";

    @Test(description = "Non ETS redirect url test for applying Drinking Water Lab Certification")
    public void mvpNonETSDrinkingWaterLabCertification() {
