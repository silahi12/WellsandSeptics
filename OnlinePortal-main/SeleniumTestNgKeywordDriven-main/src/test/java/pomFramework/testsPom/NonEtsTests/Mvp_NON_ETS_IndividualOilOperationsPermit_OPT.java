...
public class Mvp_NON_ETS_IndividualOilOperationsPermit_OPT extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Individual Oil Operations Permit: Aboveground Oil Storage, Transfer, and Maryland Companies Delivery - OPT";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/oilcontrol/pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Individual Oil Operations Permit:  Aboveground Oil Storage, Transfer, and Maryland Companies Delivery - OPT")
    public void mvpNonETSIndividualOilOperationsPermitOPT() {
