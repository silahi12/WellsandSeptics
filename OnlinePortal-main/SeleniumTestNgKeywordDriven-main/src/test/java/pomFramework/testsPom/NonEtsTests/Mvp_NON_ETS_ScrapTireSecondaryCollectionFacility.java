...
public class Mvp_NON_ETS_ScrapTireSecondaryCollectionFacility extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Scrap Tire Secondary Collection Facility";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/land/WasteManagement/Pages/ScrapTires.aspx";

    @Test(description = "Non ETS redirect url test for applying Scrap Tire Secondary Collection Facility")
    public void mvpNonETSScrapTireSecondaryCollectionFacility() {
