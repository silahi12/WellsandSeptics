...
public class Mvp_NON_ETS_HazardousWaste_EPAIdentificationNum_HazardousWasteGeneratorID extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Hazardous Waste - EPA Identification Number (Hazardous Waste Generator ID)";

    //URL
    private static final String REDIRECT_URL = "rcrainfo.epa.gov/rcrainfoprod/action/secured/login";

    @Test(description = "Non ETS redirect url test for applying Hazardous Waste - EPA Identification Number (Hazardous Waste Generator ID)")
    public void mvpNonETSHazardousWaste_EPAIdentificationNum_HazardousWasteGeneratorID() {
