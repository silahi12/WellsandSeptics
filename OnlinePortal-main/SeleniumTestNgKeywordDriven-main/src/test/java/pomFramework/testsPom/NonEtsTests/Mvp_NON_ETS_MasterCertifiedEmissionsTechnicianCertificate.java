...
public class Mvp_NON_ETS_MasterCertifiedEmissionsTechnicianCertificate extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Master Certified Emissions Technician Certificate";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/air/MobileSources/Pages/cerf.aspx";

    @Test(description = "Non ETS redirect url test for applying Master Certified Emissions Technician Certificate")
    public void mvpNonETSMasterCertifiedEmissionsTechnicianCertificate() {
