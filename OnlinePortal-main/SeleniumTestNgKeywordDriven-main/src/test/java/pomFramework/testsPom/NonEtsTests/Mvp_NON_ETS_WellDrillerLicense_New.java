...
public class Mvp_NON_ETS_WellDrillerLicense_New extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Well Driller License (New)";
    ...
    @Test(description = "Non ETS redirect url test for applying Well Driller License (New)")
    public void mvpNonETSWellDrillerLicense_New() {
