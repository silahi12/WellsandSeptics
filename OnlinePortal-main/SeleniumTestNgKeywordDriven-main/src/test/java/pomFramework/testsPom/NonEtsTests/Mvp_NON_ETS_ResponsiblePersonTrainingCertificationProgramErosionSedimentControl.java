...
public class Mvp_NON_ETS_ResponsiblePersonTrainingCertificationProgramErosionSedimentControl extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Responsible Person Training & Certification Program for Erosion/Sediment Control";

    //URL
    private static final String REDIRECT_URL = "mderpc.mde.state.md.us/Account/login.aspx";

    @Test(description = "Non ETS redirect url test for applying Responsible Person Training & Certification Program for Erosion/Sediment Control")
    public void mvpNonETSResponsiblePersonTrainingCertificationProgramErosionSedimentControl() {
