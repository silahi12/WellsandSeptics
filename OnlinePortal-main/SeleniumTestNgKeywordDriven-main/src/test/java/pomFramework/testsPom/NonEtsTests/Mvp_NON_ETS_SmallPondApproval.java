...
public class Mvp_NON_ETS_SmallPondApproval extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Small Pond Approval";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/water/DamSafety/Pages/dampermit.aspx";

    @Test(description = "Non ETS redirect url test for applying Small Pond Approval")
    public void mvpNonETSSmallPondApproval() {
