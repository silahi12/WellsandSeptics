...
public class Mvp_NON_ETS_WetStoragePermit extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Wet Storage Permit";

    //URL
    private static final String REDIRECT_URL = "mde.maryland.gov/programs/marylander/fishandshellfish/pages/index.aspx";

    @Test(description = "Non ETS redirect url test for applying Wet Storage Permit")
    public void mvpNonETSWetStoragePermit() {
