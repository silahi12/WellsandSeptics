...
public class Mvp_NON_ETS_CertificationMachinesEmittingRadiation extends BaseTestPom {
    ...
    //Permit info
    private static final String PERMIT_TYPE = "Certification of Machines Emitting Radiation";
    ...
    @Test(description = "Non ETS redirect url test for applying Certification of Machines Emitting Radiation")
    public void mvpNonETSCertificationMachinesEmittingRadiation() {
