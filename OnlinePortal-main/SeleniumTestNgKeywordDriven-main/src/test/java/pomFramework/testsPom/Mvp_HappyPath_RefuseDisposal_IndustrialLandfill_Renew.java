...
public class Mvp_HappyPath_RefuseDisposal_IndustrialLandfill_Renew extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Industrial Landfill - Renew")
    public void mvpHappyPathRefuseDisposalIndustrialLandfillRenew() throws InterruptedException {
