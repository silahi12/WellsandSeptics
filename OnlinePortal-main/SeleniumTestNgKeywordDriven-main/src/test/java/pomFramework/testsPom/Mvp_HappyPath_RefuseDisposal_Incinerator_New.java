...
public class Mvp_HappyPath_RefuseDisposal_Incinerator_New extends BaseTestPom{
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Incinerator - New")
    public void mvpHappyPathRefuseDisposalIncineratorNew() throws InterruptedException {
