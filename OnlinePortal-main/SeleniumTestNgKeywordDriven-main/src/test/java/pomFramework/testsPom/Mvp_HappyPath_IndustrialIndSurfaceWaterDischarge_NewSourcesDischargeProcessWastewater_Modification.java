...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_NewSourcesDischargeProcessWastewater_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For Industrial Surface Water Discharge Permit for New Sources that Discharge Process Wastewater";
    ...
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Individual NPDES Permit - Application Form 1 - General Information - Wastewater - WSA.pdf",
            "Individual NPDES Permit Application Form - 2D - New Manufacturing, Commercial Mining, and Silvicultural - Wastewater - WSA.pdf",
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Form 2D";
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for New Sources that Discharge Process Wastewater - Modification ")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeNewSourcesDischargeProcessWastewaterModification() throws InterruptedException {
