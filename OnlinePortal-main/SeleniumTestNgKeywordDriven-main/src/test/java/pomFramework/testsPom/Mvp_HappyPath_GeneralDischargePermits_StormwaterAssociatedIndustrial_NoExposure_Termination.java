...
public class Mvp_HappyPath_GeneralDischargePermits_StormwaterAssociatedIndustrial_NoExposure_Termination extends BaseTestPom{
    ...
    private static final String PERMIT_ACTION_TYPE = "Termination";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Termination Request Form File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Notice of Termination for Coverage - Surface Water Discharge General Permit - Wastewater - WSA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Termination Request Form";

    //Fees
    private static final String TOTAL_FEE = "NO FEE";

    @Test(description = "Happy path test for applying General Discharge Permits for Discharges of Stormwater Associated with Industrial Activity (SW)- For No Exposure Certification for Exclusion from NPDES Stormwater Permitting - Termination")
    public void mvpHappyPathGeneralDischargePermitsStormwaterAssociatedIndustrialNoExposureTermination() throws InterruptedException {
