...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_Incinerators extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Incinerators";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application Form for Incinerator File",
            "Application Form for Air Toxics Summary Sheet File",
            "Application Form for Air Toxic Emission Point Data File",
            "Application for Control Device (if applicable) File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Incinerators - Form 10 - ARA.pdf",
    ...
    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Incinerators - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructIncinerators() throws InterruptedException {
