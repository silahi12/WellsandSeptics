...
public class Mvp_HappyPath_RefuseDisposal_LandClearingDebrisLandfill_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Refuse Disposal Permit - Land Clearing Debris Landfill";
    ...
    @Test(description = "Happy path test for applying Refuse Disposal Permit - Land Clearing Debris Landfill - Modification")
    public void mvpHappyPathRefuseDisposalLandClearingDebrisLandfillModification() throws InterruptedException {
