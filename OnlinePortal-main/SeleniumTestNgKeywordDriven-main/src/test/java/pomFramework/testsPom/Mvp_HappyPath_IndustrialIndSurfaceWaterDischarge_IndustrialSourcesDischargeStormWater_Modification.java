...
public class Mvp_HappyPath_IndustrialIndSurfaceWaterDischarge_IndustrialSourcesDischargeStormWater_Modification extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "For Industrial Surface Water Discharge Permit for Industrial Sources that Discharge Storm Water Only";
    ...
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Individual NPDES Permit - Application Form 1 - General Information - Wastewater - WSA.pdf",
            "Individual NPDES Permit Application - Form 2F - Stormwater Discharges Associated with Industrial Activity - Wastewater - WSA.pdf",
    ...
    private static final String REQUIRED_UPLOAD_FILE2 = "Form 2F";
    ...
    @Test(description = "Happy path test for applying Industrial Individual Surface Water Discharge Permit - For Industrial Surface Water Discharge Permit for Industrial Sources that Discharge Storm Water Only - Modification")
    public void mvpHappyPathIndustrialIndSurfaceWaterDischargeIndustrialSourcesDischargeStormWaterModification() throws InterruptedException {
