...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_FuelBurningEquipment extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Fuel Burning Equipment";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application Form for Fuel Burning Equipment (Boilers) File",
            "Application for Control Device (if applicable) File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Fuel Burning Equipment - Form 11 - ARA.pdf",
            "Air Quality Standard Permit to Construct - Emission Control Equipment - Form 6 -ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application Form for Fuel Burning Equipment (Boilers)";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Fuel Burning Equipment - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructFuelBurningEquipment() throws InterruptedException {
