...
public class Mvp_HappyPath_AirQualityStandardPermitToConstruct_EmergencyGenerator extends BaseTestPom{
    ...
    private static final String PERMIT_DETAIL_TYPE = "Emergency Generator";
    private static final String PERMIT_ACTION_TYPE = "Standard Permit to Construct";

    //Files info
    //Download files
    private static final List<String> DOWNLOAD_FILES = List.of("Application for Emergency Generator File");
    private static final List<String> DOWNLOAD_FILES_PDF_NAMES = List.of("Air Quality Standard Permit to Construct - Emergency Generator - Form 42 - ARA.pdf");
    //Upload Files
    private static final String REQUIRED_UPLOAD_FILE = "Application for Emergency Generator";

    //Fees
    private static final String TOTAL_FEE = "To Be Determined";

    @Test(description = "Happy path test for applying Air Quality Standard Permit to Construct - Emergency Generator - Standard Permit to Construct")
    public void mvpHappyPathAirQualityStandardPermitToConstructEmergencyGenerator() throws InterruptedException {
